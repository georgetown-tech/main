...
function ProgramsPage({location}) {
  ...
  return (
    <Layout location={location} crumbLabel="programs" >
      ...
      <a href="webcal://gtowntech.org/api/events" className="fixed bottom-4 right-4 w-20 aspect-square bg-primary flex justify-center items-center rounded-3xl hover:shadow-xl transition-shadow">
